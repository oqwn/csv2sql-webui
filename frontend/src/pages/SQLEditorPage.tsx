            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                {insertColumns.map((col, index) => {
                  ...
                  const isRequired = columnInfo && !columnInfo.nullable && !columnInfo.default && !col.column.toLowerCase().includes('id');
                  const isAutoGenerated = col.column.toLowerCase().includes('id') || (columnInfo?.default && columnInfo.default.includes('nextval'));
