            ...
            <Grid container spacing={2}>
                  ...
                  onChange={async (e) => {
                    ...
                    if (tableName) {
                      ...
                      if (columns.length > 0) {
                        ...
                        // Add an empty row for additional columns
              ...
              <Grid item xs={12}>
                ...
                {insertColumns.map((col, index) => {
                  ...
                  const isEmptyRow = !col.column; // This is the extra row for custom columns
                  
                  // For empty row, show the original dropdown interface
                  if (isEmptyRow) {
                    return (
                      <Grid container spacing={1} key={index} sx={{ mb: 1 }}>
                        <Grid item xs={5}>
                          <TextField
                            ...
                            placeholder="Optional: add more columns"
                          />
                        </Grid>
                        <Grid item xs={6}>
                          <TextField
                        ...
                        <Grid item xs={1}>
                          <IconButton
                            ...
                            disabled={insertColumns.filter(c => !c.column).length <= 1}
                          >
                            <ClearIcon />
                          </IconButton>
                        </Grid>
                  ...
                  // For pre-populated columns, show the enhanced UI
                  return (
